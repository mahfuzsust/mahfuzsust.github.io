...
![Cache implementation strategy](https://cdn-images-1.medium.com/max/2000/1*enbSTt8WK0VFPxMCu9nJHw.png)*Cache implementation strategy*
...
1. Otherwise, If size exceeds capacity

1. Delete existing node using appropriate strategy

1. Add new node in the top
